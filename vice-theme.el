...
(let ((orange "#c07c63")
  ...
  (custom-theme-set-faces
   ...
   `(show-paren-mismatch ((t (:background ,red :foreground ,pale))))
   ...
   `(rainbow-delimiters-unmatched-face ((t (:foreground ,pale :background ,red))))
   `(rainbow-delimiters-mismatched-face ((t (:foreground ,pale :background ,yellow))))
