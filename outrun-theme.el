...
(let ((orange-1 "#f2502a")
  ...
  (custom-theme-set-faces
   ...
   `(isearch ((t (:background ,purple-1 :foreground "black"))))
   ...
   `(font-lock-builtin-face       ((t (:foreground ,orange-1))))
   `(font-lock-constant-face      ((t (:foreground ,orange-2))))
   `(font-lock-preprocessor-face  ((t (:foreground ,pink-1 :italic t))))
   ...
   `(font-lock-function-name-face ((t (:foreground ,purple-1))))
